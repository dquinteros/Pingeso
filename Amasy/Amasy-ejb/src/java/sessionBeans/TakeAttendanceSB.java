...
public class TakeAttendanceSB implements TakeAttendanceSBLocal {
    ...
    public ResponseAssistanceDTO validateFingerprintBM(String fingerprint, BlockClass blockClass){        
        ...
        if(listUser!=null){
            ...
            Student student;
            boolean addStudentAssistance;
            ResponseAssistanceDTO responseAssistanceDTO;  
            ...
            addStudentAssistance = addStudentAssistance(student, blockClass);
            responseAssistanceDTO = new ResponseAssistanceDTO(userDTO, addStudentAssistance);
