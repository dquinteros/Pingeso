...
@NamedQueries({
    ...
    @NamedQuery(name = "Assistance.getAssistanceStudentToCourse", query = "SELECT a FROM Assistance a WHERE a.blockClass.course.id = :idCourse AND a.student.user.id = :idUser AND a.student.user.userStatus = true ORDER BY a.date ASC")
})
@Entity
